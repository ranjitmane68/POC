...
var loggerProvider = new _sdkLogs.LoggerProvider({
  resource: new _resources.Resource((_ref = {}, _defineProperty(_ref, _semanticConventions.SEMRESATTRS_SERVICE_NAME, "angular-otel-observability"), _defineProperty(_ref, _semanticConventions.SEMRESATTRS_SERVICE_NAMESPACE, "angular-otel-observability"), _ref))
});
