...
var _ModuleNameTrie = require('./ModuleNameTrie');
...
var RequireInTheMiddleSingleton = exports.RequireInTheMiddleSingleton = function () {
    function RequireInTheMiddleSingleton() {
        _classCallCheck(this, RequireInTheMiddleSingleton);

        this._moduleNameTrie = new _ModuleNameTrie.ModuleNameTrie();
        this._initialize();
    }
...
function normalizePathSeparators(moduleNameOrPath) {
    return path.sep !== _ModuleNameTrie.ModuleNameSeparator ? moduleNameOrPath.split(path.sep).join(_ModuleNameTrie.ModuleNameSeparator) : moduleNameOrPath;
}
