...
var InstrumentationBase = /** @class */function (_super) {
    ...
    InstrumentationBase.prototype.enable = function () {
        ...
        var _loop_1 = function _loop_1(module_2) {
            ...
            var hook = path.isAbsolute(module_2.name) ? new _requireInTheMiddle.Hook([module_2.name], { internals: true }, onRequire) : this_1._requireInTheMiddleSingleton.register(module_2.name, onRequire);
            this_1._hooks.push(hook);
            var esmHook = new _importInTheMiddle.Hook([module_2.name], { internals: false }, hookFn);
