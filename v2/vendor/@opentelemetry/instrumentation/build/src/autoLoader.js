...
var autoLoaderUtils_1 = require("./autoLoaderUtils");
/**
...
function registerInstrumentations(options) {
  var _a, _b;
  var tracerProvider = options.tracerProvider || api_1.trace.getTracerProvider();
  var meterProvider = options.meterProvider || api_1.metrics.getMeterProvider();
  var loggerProvider = options.loggerProvider || api_logs_1.logs.getLoggerProvider();
