...
var ModuleNameTrie = function () {
    ...
    _createClass(ModuleNameTrie, [{
        ...
        value: function insert(hook) {
            ...
            try {
                for (var _iterator = hook.moduleName.split(exports.ModuleNameSeparator)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        value: function search(moduleName) {
            ...
            try {
                for (var _iterator2 = moduleName.split(exports.ModuleNameSeparator)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
