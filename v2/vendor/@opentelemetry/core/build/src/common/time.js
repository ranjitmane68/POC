...
function getTimeOrigin() {
    var timeOrigin = platform_1.otperformance.timeOrigin;
    if (typeof timeOrigin !== 'number') {
        var perf = platform_1.otperformance;
...
function hrTime(performanceNow) {
    ...
    var now = millisToHrTime(typeof performanceNow === 'number' ? performanceNow : platform_1.otperformance.now());
