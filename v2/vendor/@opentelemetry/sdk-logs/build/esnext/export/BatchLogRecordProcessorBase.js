...
var BatchLogRecordProcessorBase = exports.BatchLogRecordProcessorBase = function () {
    function BatchLogRecordProcessorBase(_exporter, config) {
        ...
        if (this._maxExportBatchSize > this._maxQueueSize) {
            _api.diag.warn('BatchLogRecordProcessor: maxExportBatchSize must be smaller or equal to maxQueueSize, setting maxExportBatchSize to match maxQueueSize');
    ...
    _createClass(BatchLogRecordProcessorBase, [{
        ...
        value: function _flushOneBatch() {
            ...
            return new Promise(function (resolve, reject) {
                (0, _core.callWithTimeout)(_this2._export(_this2._finishedLogRecords.splice(0, _this2._maxExportBatchSize)), _this2._exportTimeoutMillis).then(function () {
                    return resolve();
                }).catch(reject);
            });
        }
        ...
        value: function _export(logRecords) {
            ...
            var doExport = function doExport() {
                return _core.internal._export(_this4._exporter, logRecords).then(function (result) {
                    var _a;
                    if (result.code !== _core.ExportResultCode.SUCCESS) {
                        (0, _core.globalErrorHandler)((_a = result.error) !== null && _a !== void 0 ? _a : new Error('BatchLogRecordProcessor: log record export failed (status ' + result + ')'));
                    }
            ...
            if (pendingResources.length === 0) {
                ...
                })).then(doExport, _core.globalErrorHandler);
            }
        }
    }]);
