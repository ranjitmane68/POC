...
var OTLPLogExporter = /** @class */function (_super) {
    ...
    function OTLPLogExporter(config) {
        ...
        _this.headers = __assign(__assign(__assign(__assign({}, _this.headers), USER_AGENT), _core.baggageUtils.parseKeyPairsIntoRecord((0, _core.getEnv)().OTEL_EXPORTER_OTLP_LOGS_HEADERS)), (0, _otlpExporterBase.parseHeaders)(config === null || config === void 0 ? void 0 : config.headers));
        return _this;
    }
