 ...
 */
var detectResources = exports.detectResources = function detectResources(config) {
    if (config === void 0) {
        config = {};
    }
                        ...
                        return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        resource = _a.sent();
                                        _api.diag.debug(d.constructor.name + " found resource.", resource);
                                        return [2 /*return*/, resource];
                                    case 2:
                                        e_1 = _a.sent();
                                        _api.diag.debug(d.constructor.name + " failed: " + e_1.message);
                                        return [2 /*return*/, _Resource.Resource.empty()];
                                    case 3:
                                        return [2 /*return*/];
                                }
                            });
 ...
 * @param config Configuration for resource detection
 */
var detectResourcesSync = exports.detectResourcesSync = function detectResourcesSync(config) {
    var _a;
    if (config === void 0) {
        config = {};
    }
    var resources = ((_a = config.detectors) !== null && _a !== void 0 ? _a : []).map(function (d) {
        try {
            ...
            var resource_1;
            if ((0, _utils.isPromiseLike)(resourceOrPromise_1)) {
                ...
                resource_1 = new _Resource.Resource({}, createPromise());
            } else {
                resource_1 = resourceOrPromise_1;
            }
            if (resource_1.waitForAsyncAttributes) {
                void resource_1.waitForAsyncAttributes().then(function () {
                    return _api.diag.debug(d.constructor.name + " found resource.", resource_1);
                });
            } else {
                _api.diag.debug(d.constructor.name + " found resource.", resource_1);
            }
            return resource_1;
        } catch (e) {
            _api.diag.error(d.constructor.name + " failed: " + e.message);
...
var logResources = function logResources(resources) {
    resources.forEach(function (resource) {
        ...
        if (Object.keys(resource.attributes).length > 0) {
            ...
            _api.diag.verbose(resourceDebugString);
        }
    });
};
