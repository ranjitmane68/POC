    ...
    EnvDetectorSync.prototype.detect = function (_config) {
        ...
        if (rawAttributes) {
            try {
                ...
                _api.diag.debug("EnvDetector failed: " + e.message);
            }
        }
        if (serviceName) {
            attributes[_semanticConventions.SEMRESATTRS_SERVICE_NAME] = serviceName;
        }
...
var envDetectorSync = exports.envDetectorSync = new EnvDetectorSync();
