...
var OSDetectorSync = function () {
    ...
    _createClass(OSDetectorSync, [{
        ...
        value: function detect(_config) {
            ...
            var attributes = (_attributes = {}, _defineProperty(_attributes, _semanticConventions.SEMRESATTRS_OS_TYPE, (0, _utils.normalizeType)((0, _os.platform)())), _defineProperty(_attributes, _semanticConventions.SEMRESATTRS_OS_VERSION, (0, _os.release)()), _attributes);
