...
var BrowserDetectorSync = function () {
    ...
    _createClass(BrowserDetectorSync, [{
        ...
        value: function detect(config) {
            ...
            var browserResource = (_browserResource = {}, _defineProperty(_browserResource, semantic_conventions_1.SEMRESATTRS_PROCESS_RUNTIME_NAME, 'browser'), _defineProperty(_browserResource, semantic_conventions_1.SEMRESATTRS_PROCESS_RUNTIME_DESCRIPTION, 'Web Browser'), _defineProperty(_browserResource, semantic_conventions_1.SEMRESATTRS_PROCESS_RUNTIME_VERSION, navigator.userAgent), _browserResource);
