            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.prev = 0;
                        _context.next = 3;
                        return fs_1.promises.readFile('/etc/hostid', { encoding: 'utf8' });
                    ...
                    case 10:
                        _context.prev = 10;
                        _context.next = 13;
                        return (0, execAsync_1.execAsync)('kenv -q smbios.system.uuid');
                    ...
                    case 17:
                        ...
                        api_1.diag.debug("error reading machine id: " + _context.t1);
