...
var _internal2 = require('../common/internal');

var _internal3 = require('../resource/internal');
...
function spanRecordsToResourceSpans(readableSpans, encoder) {
    ...
    while (!entry.done) {
        ...
        while (!ilmEntry.done) {
            ...
            if (scopeSpans.length > 0) {
                ...
                scopeResourceSpans.push({
                    scope: (0, _internal2.createInstrumentationScope)(scopeSpans[0].instrumentationLibrary),
                    spans: spans,
        ...
        var transformedSpans = {
            resource: (0, _internal3.createResource)(resource),
