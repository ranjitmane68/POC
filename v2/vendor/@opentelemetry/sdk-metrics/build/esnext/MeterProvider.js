 ...
 */
var MeterProvider = exports.MeterProvider = function () {
    function MeterProvider(options) {
        _classCallCheck(this, MeterProvider);

        var _a;
        this._shutdown = false;
        var resource = _resources.Resource.default().merge((_a = options === null || options === void 0 ? void 0 : options.resource) !== null && _a !== void 0 ? _a : _resources.Resource.empty());
