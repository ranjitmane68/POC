...
var _MetricReader2 = require('./MetricReader');
 ...
 */
var PeriodicExportingMetricReader = exports.PeriodicExportingMetricReader = function (_MetricReader) {
    _inherits(PeriodicExportingMetricReader, _MetricReader);
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.prev = 0;
                                _context.next = 3;
                                return (0, _utils.callWithTimeout)(this._doRun(), this._exportTimeout);
                            ...
                            case 5:
                                ...
                                if (!(_context.t0 instanceof _utils.TimeoutError)) {
                                    _context.next = 10;
                                    break;
                                }
                            ...
                            case 10:
                                (0, _core.globalErrorHandler)(_context.t0);
                                        ...
                                        return regeneratorRuntime.wrap(function _callee2$(_context2) {
                                            while (1) {
                                                switch (_context2.prev = _context2.next) {
                                                    case 0:
                                                        _context2.next = 2;
                                                        return _core.internal._export(_this2._exporter, resourceMetrics);
