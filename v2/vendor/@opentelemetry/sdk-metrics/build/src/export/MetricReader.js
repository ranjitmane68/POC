...
var AggregationSelector_1 = require("./AggregationSelector");
/**
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 6:
                                ...
                                errors = sdkCollectionResults.errors.concat((0, utils_1.FlatMap)(additionalCollectionResults, function (result) {
                                    return result.errors;
                                }));
                                resource = sdkCollectionResults.resourceMetrics.resource;
                                scopeMetrics = sdkCollectionResults.resourceMetrics.scopeMetrics.concat((0, utils_1.FlatMap)(additionalCollectionResults, function (result) {
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 8:
                                _context2.next = 10;
                                return (0, utils_1.callWithTimeout)(this.onShutdown(), options.timeoutMillis);
                ...
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 7:
                                _context3.next = 9;
                                return (0, utils_1.callWithTimeout)(this.onForceFlush(), options.timeoutMillis);
