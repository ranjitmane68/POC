...
var XMLHttpRequestInstrumentation = exports.XMLHttpRequestInstrumentation = function (_InstrumentationBase) {
    _inherits(XMLHttpRequestInstrumentation, _InstrumentationBase);
    ...
    function XMLHttpRequestInstrumentation() {
        ...
        var _this = _possibleConstructorReturn(this, (XMLHttpRequestInstrumentation.__proto__ || Object.getPrototypeOf(XMLHttpRequestInstrumentation)).call(this, '@opentelemetry/instrumentation-xml-http-request', _version.VERSION, config));
    ...
    _createClass(XMLHttpRequestInstrumentation, [{
        ...
        value: function _createSpan(xhr, url, method) {
            ...
            var currentSpan = this.tracer.startSpan(spanName, {
                ...
                attributes: (_attributes = {}, _defineProperty(_attributes, _semanticConventions.SEMATTRS_HTTP_METHOD, method), _defineProperty(_attributes, _semanticConventions.SEMATTRS_HTTP_URL, (0, _sdkTraceWeb.parseUrl)(url).toString()), _attributes)
            });
