...
var AlwaysOffSampler_1 = require("./AlwaysOffSampler");
var AlwaysOnSampler_1 = require("./AlwaysOnSampler");
/**
...
var ParentBasedSampler = function () {
    function ParentBasedSampler(config) {
        _classCallCheck(this, ParentBasedSampler);
    ...
    _createClass(ParentBasedSampler, [{
        key: "shouldSample",
        value: function shouldSample(context, traceId, spanName, spanKind, attributes, links) {
            var parentContext = api_1.trace.getSpanContext(context);
