...
var OTLPTraceExporter = exports.OTLPTraceExporter = function (_OTLPExporterNodeBase) {
    _inherits(OTLPTraceExporter, _OTLPExporterNodeBase);
    ...
    function OTLPTraceExporter() {
        ...
        _this.headers = Object.assign(Object.assign(Object.assign(Object.assign({}, _this.headers), USER_AGENT), _core.baggageUtils.parseKeyPairsIntoRecord((0, _core.getEnv)().OTEL_EXPORTER_OTLP_TRACES_HEADERS)), (0, _otlpExporterBase.parseHeaders)(config === null || config === void 0 ? void 0 : config.headers));
        return _this;
    }
