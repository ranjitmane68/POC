...
var BatchLogRecordProcessorBase = /** @class */function () {
    ...
    BatchLogRecordProcessorBase.prototype._flushOneBatch = function () {
        ...
        return new Promise(function (resolve, reject) {
            (0, _core.callWithTimeout)(_this._export(_this._finishedLogRecords.splice(0, _this._maxExportBatchSize)), _this._exportTimeoutMillis).then(function () {
                return resolve();
            }).catch(reject);
        });
    };
    ...
    BatchLogRecordProcessorBase.prototype._export = function (logRecords) {
        ...
        var doExport = function doExport() {
            return _core.internal._export(_this._exporter, logRecords).then(function (result) {
                var _a;
