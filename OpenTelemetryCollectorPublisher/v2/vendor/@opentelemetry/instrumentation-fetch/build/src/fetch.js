...
var web = require("@opentelemetry/sdk-trace-web");
...
var FetchInstrumentation = function (_instrumentation_1$In) {
    _inherits(FetchInstrumentation, _instrumentation_1$In);
    ...
    function FetchInstrumentation() {
        ...
        var _this = _possibleConstructorReturn(this, (FetchInstrumentation.__proto__ || Object.getPrototypeOf(FetchInstrumentation)).call(this, '@opentelemetry/instrumentation-fetch', version_1.VERSION, config));
    ...
    _createClass(FetchInstrumentation, [{
        ...
        value: function _createSpan(url) {
            ...
            return this.tracer.startSpan(spanName, {
                ...
                attributes: (_attributes = {}, _defineProperty(_attributes, AttributeNames_1.AttributeNames.COMPONENT, this.moduleName), _defineProperty(_attributes, semantic_conventions_1.SEMATTRS_HTTP_METHOD, method), _defineProperty(_attributes, semantic_conventions_1.SEMATTRS_HTTP_URL, url), _attributes)
            });
        }
        /**
