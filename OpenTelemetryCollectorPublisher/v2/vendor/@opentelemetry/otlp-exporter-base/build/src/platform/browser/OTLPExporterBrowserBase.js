...
var OTLPExporterBrowserBase = function (_OTLPExporterBase_1$O) {
    _inherits(OTLPExporterBrowserBase, _OTLPExporterBase_1$O);
    ...
    function OTLPExporterBrowserBase() {
        ...
        if (_this._useXHR) {
            _this._headers = Object.assign({}, (0, util_1.parseHeaders)(config.headers), core_1.baggageUtils.parseKeyPairsIntoRecord((0, core_1.getEnv)().OTEL_EXPORTER_OTLP_HEADERS));
        } else {
            _this._headers = {};
        }
        return _this;
    ...
    _createClass(OTLPExporterBrowserBase, [{
        ...
        value: function send(items, onSuccess, onError) {
            ...
            var promise = new Promise(function (resolve, reject) {
                if (_this2._useXHR) {
                    (0, util_2.sendWithXhr)(body, _this2.url, Object.assign(Object.assign({}, _this2._headers), { 'Content-Type': _this2._contentType }), _this2.timeoutMillis, resolve, reject);
                } else {
                    (0, util_2.sendWithBeacon)(body, _this2.url, { type: _this2._contentType }, resolve, reject);
                }
