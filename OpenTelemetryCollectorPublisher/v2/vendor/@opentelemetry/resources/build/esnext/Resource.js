...
var Resource = exports.Resource = function () {
    ...
    attributes, asyncAttributesPromise) {
        ...
        this._asyncAttributesPromise = asyncAttributesPromise === null || asyncAttributesPromise === void 0 ? void 0 : asyncAttributesPromise.then(function (asyncAttributes) {
            ...
            _api.diag.debug("a resource's async attributes promise rejected: %s", err);
            _this.asyncAttributesPending = false;
            return {};
        });
    }
    ...
    _createClass(Resource, [{
        ...
        get: function get() {
            var _a;
            if (this.asyncAttributesPending) {
                _api.diag.error('Accessing resource attributes before async attributes settled');
            }
        ...
        value: function _default() {
            ...
            return new Resource((_ref4 = {}, _defineProperty(_ref4, _semanticConventions.SEMRESATTRS_SERVICE_NAME, (0, _platform.defaultServiceName)()), _defineProperty(_ref4, _semanticConventions.SEMRESATTRS_TELEMETRY_SDK_LANGUAGE, _core.SDK_INFO[_semanticConventions.SEMRESATTRS_TELEMETRY_SDK_LANGUAGE]), _defineProperty(_ref4, _semanticConventions.SEMRESATTRS_TELEMETRY_SDK_NAME, _core.SDK_INFO[_semanticConventions.SEMRESATTRS_TELEMETRY_SDK_NAME]), _defineProperty(_ref4, _semanticConventions.SEMRESATTRS_TELEMETRY_SDK_VERSION, _core.SDK_INFO[_semanticConventions.SEMRESATTRS_TELEMETRY_SDK_VERSION]), _ref4));
        }
    }]);
