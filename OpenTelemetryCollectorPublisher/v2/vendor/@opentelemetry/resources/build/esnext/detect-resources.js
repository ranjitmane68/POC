 ...
 */
var detectResources = exports.detectResources = function () {
                                    ...
                                    while (1) {
                                        switch (_context.prev = _context.next) {
                                            ...
                                            case 8:
                                                ...
                                                _api.diag.debug(d.constructor.name + ' failed: ' + _context.t0.message);
                                                return _context.abrupt('return', _Resource.Resource.empty());
 ...
 * @param config Configuration for resource detection
 */
var detectResourcesSync = exports.detectResourcesSync = function detectResourcesSync() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    var resources = ((_a = config.detectors) !== null && _a !== void 0 ? _a : []).map(function (d) {
        try {
            ...
            var resource = void 0;
            if ((0, _utils.isPromiseLike)(resourceOrPromise)) {
                ...
                resource = new _Resource.Resource({}, createPromise());
            } else {
                resource = resourceOrPromise;
            }
            if (resource.waitForAsyncAttributes) {
                void resource.waitForAsyncAttributes().then(function () {
                    return _api.diag.debug(d.constructor.name + ' found resource.', resource);
                });
            } else {
                _api.diag.debug(d.constructor.name + ' found resource.', resource);
            }
