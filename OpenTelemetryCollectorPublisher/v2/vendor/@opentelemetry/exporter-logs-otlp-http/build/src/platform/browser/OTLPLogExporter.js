...
var OTLPLogExporter = function (_otlp_exporter_base_) {
    ...
    function OTLPLogExporter() {
        ...
        _this._headers = Object.assign(Object.assign({}, _this._headers), core_1.baggageUtils.parseKeyPairsIntoRecord((0, core_1.getEnv)().OTEL_EXPORTER_OTLP_LOGS_HEADERS));
        return _this;
    }
...
}(otlp_exporter_base_1.OTLPExporterBrowserBase);
