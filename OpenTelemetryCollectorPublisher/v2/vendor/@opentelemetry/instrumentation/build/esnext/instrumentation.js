...
var shimmer = _interopRequireWildcard(_shimmer);
 ...
 */
var InstrumentationAbstract = exports.InstrumentationAbstract = function () {
    function InstrumentationAbstract(instrumentationName, instrumentationVersion, config) {
        ...
        this._meter = _api.metrics.getMeter(instrumentationName, instrumentationVersion);
        this._logger = _apiLogs.logs.getLogger(instrumentationName, instrumentationVersion);
