...
var DiagAPI = function () {
    ...
    function DiagAPI() {
        ...
        var setLogger = function setLogger(logger) {
            var optionsOrLogLevel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { logLevel: types_1.DiagLogLevel.INFO };
            ...
            var oldLogger = (0, global_utils_1.getGlobal)('diag');
            var newLogger = (0, logLevelLogger_1.createLogLevelDiagLogger)((_b = optionsOrLogLevel.logLevel) !== null && _b !== void 0 ? _b : types_1.DiagLogLevel.INFO, logger);
