...
var HistogramAccumulation = exports.HistogramAccumulation = function () {
    ...
    _createClass(HistogramAccumulation, [{
        ...
        value: function record(value) {
            ...
            var idx = (0, _utils.binarySearchLB)(this._boundaries, value);
...
var HistogramAggregator = exports.HistogramAggregator = function () {
    /**
    ...
    _createClass(HistogramAggregator, [{
        ...
        value: function toMetricData(descriptor, aggregationTemporality, accumulationByAttributes, endTime) {
            return {
                ...
                dataPointType: _MetricData.DataPointType.HISTOGRAM,
