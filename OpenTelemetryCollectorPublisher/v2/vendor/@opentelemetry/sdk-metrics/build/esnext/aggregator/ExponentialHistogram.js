...
var ExponentialHistogramAccumulation = exports.ExponentialHistogramAccumulation = function () {
    function ExponentialHistogramAccumulation() {
        ...
        var _positive = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : new _Buckets.Buckets();

        var _negative = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : new _Buckets.Buckets();

        var _mapping = arguments.length > 10 && arguments[10] !== undefined ? arguments[10] : (0, _getMapping.getMapping)(MAX_SCALE);
        ...
        if (this._maxSize < MIN_MAX_SIZE) {
            _api.diag.warn('Exponential Histogram Max Size set to ' + this._maxSize + ',                 changing to the minimum size of: ' + MIN_MAX_SIZE);
...
var ExponentialHistogramAggregator = exports.ExponentialHistogramAggregator = function () {
    /**
    ...
    function ExponentialHistogramAggregator(_maxSize, _recordMinMax) {
        ...
        this._maxSize = _maxSize;
        this._recordMinMax = _recordMinMax;
        this.kind = _types.AggregatorKind.EXPONENTIAL_HISTOGRAM;
    }
    ...
    _createClass(ExponentialHistogramAggregator, [{
        ...
        value: function toMetricData(descriptor, aggregationTemporality, accumulationByAttributes, endTime) {
            return {
                ...
                dataPointType: _MetricData.DataPointType.EXPONENTIAL_HISTOGRAM,
                dataPoints: accumulationByAttributes.map(function (_ref) {
                    ...
                    var allowsNegativeValues = descriptor.type === _InstrumentDescriptor.InstrumentType.GAUGE || descriptor.type === _InstrumentDescriptor.InstrumentType.UP_DOWN_COUNTER || descriptor.type === _InstrumentDescriptor.InstrumentType.OBSERVABLE_GAUGE || descriptor.type === _InstrumentDescriptor.InstrumentType.OBSERVABLE_UP_DOWN_COUNTER;
                    return {
