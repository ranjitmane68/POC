...
var LastValueAggregator = function () {
    ...
    _createClass(LastValueAggregator, [{
        ...
        value: function merge(previous, delta) {
            ...
            var latestAccumulation = (0, core_1.hrTimeToMicroseconds)(delta.sampleTime) >= (0, core_1.hrTimeToMicroseconds)(previous.sampleTime) ? delta : previous;
        ...
        value: function diff(previous, current) {
            // nanoseconds may lose precisions.
            var latestAccumulation = (0, core_1.hrTimeToMicroseconds)(current.sampleTime) >= (0, core_1.hrTimeToMicroseconds)(previous.sampleTime) ? current : previous;
