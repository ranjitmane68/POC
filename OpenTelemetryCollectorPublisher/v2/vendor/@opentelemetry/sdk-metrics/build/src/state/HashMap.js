...
var AttributeHashMap = function (_HashMap) {
    _inherits(AttributeHashMap, _HashMap);

    function AttributeHashMap() {
        _classCallCheck(this, AttributeHashMap);

        return _possibleConstructorReturn(this, (AttributeHashMap.__proto__ || Object.getPrototypeOf(AttributeHashMap)).call(this, utils_1.hashAttributes));
    }
